...
from modules.nnll_35.src import get_last_num_from_filename
...
class TestGetLastNumFromFilename(unittest.TestCase):
    ...
    def test_multiple_digits(self):
        ...
        search_value = "of"
        self.assertEqual(get_last_num_from_filename(filename, search_value),00)  # Current implementation only supports up to 2 digits
