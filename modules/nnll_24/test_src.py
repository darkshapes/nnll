...
class TestKeyTrail(unittest.TestCase):
    ...
    def test_pull_key_names_hash_match(self):
        ...
        nested_filter = {
            'x':
                {
                'blocks': 'c1d2', 'shapes': [256],
                },
            'z':
                {
                'blocks': "c2d2", 'shapes': [512], 'hash': '6f79c1397cb9ce1dac363722dbe70147aee0ccca75e28338f8482fe515891399'
                },
            'y': {
                'blocks': 'c.d', 'shapes': [256], 'hash': 'ff4824aca94dd6111e0340fa749347fb74101060d9712cb5ef1ca8f1cf17502f'
                },
            'w': {
                'blocks': 'c.d', 'shapes': [256], 'hash': hashlib.sha256(b"Software design is my passion.").hexdigest()
                }
        }
        model_header = {'c.d': {'shape': [256]}}
    ...
    def test_pull_key_names_file_size_match(self):
        ...
        nested_filter = {
            'w': {
                'blocks': 'c.d', 'shapes': [256], 'file_size': '0'
                },
            'x': {
                'blocks': 'c.d', 'shapes': [256], 'file_size': '8192'
                },
            'z': {
                'blocks': 'c.d', 'shapes': [256], 'file_size': 30
                },
            'y': {
                'blocks': 'c.d', 'shapes': [256], 'file_size': '1024'
                }
