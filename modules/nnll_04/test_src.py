...
class TestLoadMetadataSafetensors(unittest.TestCase):
    ...
    def test_metadata_from_safetensors(self):
        ...
        self.folder_path_named, folder_contents = download_hub_file(repo_id='exdysa/tiny-random-gpt2-safetensors', filename='model.safetensors', local_dir=self.local_folder_test)
