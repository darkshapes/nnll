...
def main():
    ...
    parser.add_argument(
        "path", help="Path to directory where files should be analyzed. (default .)", default="."
    )
    parser.add_argument(
        "save", help="Path where output should be stored. (default: current directory)", default="."
    )
