...
from modules.nnll_01.src import logger
from modules.nnll_48.src import MetadataFileReader
from modules.nnll_47.src import UpField, DownField, EmptyField
from modules.nnll_49.src import (
...
class TestParseMetadata(unittest.TestCase):
    ...
    def test_arrange_webui_metadata(self):
        ...
        with (
            patch(
                "modules.nnll_49.src.delineate_by_esc_codes",
                mock_delineate_by_esc_codes,
            ),
            patch("modules.nnll_49.src.extract_prompts", mock_extract_prompts),
            patch(
                "modules.nnll_49.src.extract_dict_by_delineation",
                mock_extract_dict_by_delineation,
            ),
            patch(
                "modules.nnll_49.src.make_paired_str_dict",
    ...
    @patch("modules.nnll_49.src.redivide_nodeui_data_in")
    ...
    @patch("modules.nnll_49.src.debug_message")
    ...
    @patch("modules.nnll_49.src.clean_with_json")
    @patch("modules.nnll_49.src.filter_keys_of")
    ...
    @patch("modules.nnll_49.src.arrange_webui_metadata")
    ...
    @patch("modules.nnll_49.src.arrange_nodeui_metadata")
    ...
    @patch("modules.nnll_49.src.coordinate_metadata_operations")
    @patch("modules.nnll_48.src.MetadataFileReader.read_header")
    @patch("modules.nnll_49.src.nfo")
    def test_parse_fail(
        self,
        mock_nfo,
        mock_read,
    ...
    @patch("modules.nnll_49.src.MetadataFileReader")
    def test_success(self, MockReader):
        """test"""
        mock_reader = MockReader.return_value
        mock_reader.read_header.return_value = "header"
        with patch("modules.nnll_49.src.coordinate_metadata_operations", return_value={"key": "value"}):
