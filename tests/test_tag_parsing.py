...
class TestParseMetadata(unittest.TestCase):
    ...
    def test_arrange_webui_metadata(self):
        ...
        with (
            patch(
                "nnll.metadata.webui_tags.delineate_by_esc_codes",
                mock_delineate_by_esc_codes,
            ),
            patch("nnll.metadata.webui_tags.extract_prompts", mock_extract_prompts),
            patch(
                "nnll.metadata.webui_tags.extract_dict_by_delineation",
                mock_extract_dict_by_delineation,
            ),
            patch(
                "nnll.metadata.webui_tags.make_paired_str_dict",
    ...
    @patch("nnll.metadata.webui_tags.redivide_nodeui_data_in")
    ...
    @patch("nnll.metadata.webui_tags.dbug")
    ...
    @patch("nnll.metadata.webui_tags.clean_with_json")
    @patch("nnll.metadata.webui_tags.filter_keys_of")
    ...
    @patch("nnll.metadata.webui_tags.arrange_webui_metadata")
    ...
    @patch("nnll.metadata.webui_tags.arrange_nodeui_metadata")
    ...
    @patch("nnll.metadata.webui_tags.coordinate_metadata_operations")
    @patch("nnll.metadata.read_tags.MetadataFileReader.read_header")
    @patch("nnll.metadata.webui_tags.nfo")
    def test_parse_fail(
        self,
        mock_nfo,
        mock_read,
