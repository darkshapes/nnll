...
# from nnll_43 import write_toc_to_file
...
#             write_toc_to_file(module_index, index_file_name="__init__.py", root_folder=tmpdir)
#             with open(Path(tmpdir) / "__init__.py", encoding="utf-8") as f:
#                 content = f.read()
