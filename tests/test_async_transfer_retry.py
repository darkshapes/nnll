...
from nnll.download.async_download import async_remote_transfer, prepare_download, retry, async_save_file
...
async def test_save_file_async():
    ...
    with patch("nnll.download.async_download.async_open", new_callable=AsyncMock) as mock_open:
