...
class ModelTool:
    ...
    def gguf_check(self, file_path_named: str) -> tuple:
        ...
        try:
            ...
            self.nfo(f"Error reading GGUF header from {file_path_named}: {error_log}")
        else:
    ...
    def attempt_file_open(self, file_path_named: str) -> dict:
        ...
        if metadata:
            ...
            try:
                ...
                self.nfo("Parsing .gguf file failed for %s", file_path_named, error_log)
        return metadata
        ...
        with open(file_path_named, "rb") as file_contents_to:
            ...
            if assembled_data.get("__metadata__"):
                try:
                    ...
                    self.nfo("Couldnt remove '__metadata__' from header data. %s", header_data, error_log)
